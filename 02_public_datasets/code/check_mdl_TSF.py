...
# Here: time series forecasting (Electricity, Traffic, Solar-Energy)
# ------------------------------------------------------------------
...
# model to check
model_name = "model_N48_m47_stateless retrain"
...
if dataset_name == 'electricity':
    data_path = "data/data_electricity_0_10_hours_kWh.csv"
    seq_len = 10000
    variate = 5
elif dataset_name == 'traffic':
    data_path = "data/data_traffic.csv"
    seq_len = 10000
    variate = 9
elif dataset_name == 'solar':
    data_path = "data/data_solar.csv"
    seq_len = 20000
    variate = 2
else:
...
z_train, z_scaler, z_train_unscaled = load_data_training(data_path, seq_len, variate, scaler = "MinMaxScaler")
dataset_X, dataset_indices = create_sequences(z_train)
...
input_size = np.size(z_train,axis=1)
output_size = forecasting_length_H * input_size
number_of_layers = 1
